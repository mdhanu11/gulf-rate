  ...
  const onSubmit = (values: FormValues) => {
    ...
    if (window.gtag) {
      window.gtag('event', 'lead_form_submit', {
        ...
        event_label: `${values.fromCurrency} to ${values.toCurrency}`
      });
    }
  };
    ...
    <section id="alerts" className="relative py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold text-white">{t('alerts.title')}</h2>
          <div className="h-1 w-20 bg-yellow-400 mx-auto my-4 rounded-full"></div>
          <p className="mt-4 text-blue-100 max-w-2xl mx-auto text-lg">{t('alerts.subtitle')}</p>
        </div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-5/12 bg-gradient-to-br from-blue-500 to-blue-700 p-8 text-white">
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-bold">{t('leadCapture.title')}</h3>
                  </div>
                </div>
                
                <p className="text-blue-100 mb-8">{t('leadCapture.description')}</p>
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-white">{t('leadCapture.features.0.title')}</h4>
                      <p className="text-blue-100 text-sm">{t('leadCapture.features.0.description')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-white">{t('leadCapture.features.1.title')}</h4>
                      <p className="text-blue-100 text-sm">{t('leadCapture.features.1.description')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-white">{t('leadCapture.features.2.title')}</h4>
                      <p className="text-blue-100 text-sm">{t('leadCapture.features.2.description')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-sm text-blue-100 pb-6 border-t border-blue-400 pt-6">
                  ...
                  <a href="#" className="text-yellow-300 hover:text-yellow-200 underline">{t('leadCapture.privacyLink')}</a>.
                </div>
              </div>
              ...
              <div className="md:w-7/12 p-8">
                <h3 className="text-lg font-semibold text-gray-800 mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">{t('leadCapture.form.name')}</FormLabel>
                          <FormControl>
                            <Input 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">{t('leadCapture.form.email')}</FormLabel>
                          <FormControl>
                            <Input 
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="col-span-2">
                            <FormLabel className="text-gray-700">{t('leadCapture.form.countryCode')}</FormLabel>
                            <Select 
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="col-span-3">
                            <FormLabel className="text-gray-700">{t('leadCapture.form.phone')}</FormLabel>
                            <FormControl>
                              <Input 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-gray-700">{t('leadCapture.form.fromCurrency')}</FormLabel>
                            <Select 
                              onValueChange={field.onChange} 
                              defaultValue={field.value}
                            >
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-gray-700">{t('leadCapture.form.toCurrency')}</FormLabel>
                            <Select 
                              onValueChange={field.onChange} 
                              defaultValue={field.value}
                            >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">{t('leadCapture.form.targetRate')}</FormLabel>
                          <FormControl>
                            <Input 
                    ...
                    >
                      {mutation.isPending ? (
                        ...
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <span>{t('leadCapture.form.submit')}</span>
                        </div>
                      )}
                    </Button>
                  </form>
